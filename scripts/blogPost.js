/*
 * Programming Quiz: Build an HTML Fragment (1-2) to be changed
 */
  ...
  const cardHTML = `<div class="card">
        ...
        <div class="description">
            ...
            <ul class="details">
                ...
                <li><span class="bold">Average Lifespan</span>: ${animal.lifespan}</li>                <li><span class="bold">Average Speed</span>: ${animal.speed} </li>
